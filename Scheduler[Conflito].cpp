...
std::tuple<int, int, float> Scheduler::nCAR_v2(std::shared_ptr<std::vector<std::shared_ptr<PickTask> > > _pick_tasks_ref,
    ...
    return std::make_tuple(n_sch_robots, n_visits_to_depot, c_total);
}

std::tuple<int, int, float> Scheduler::fifo(std::shared_ptr<std::vector<std::shared_ptr<PickTask> > > _pick_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<DeliverTask> > > _deliver_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<RechargeTask> > > _recharge_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<Robot> > >& _robots_ref,
        CostEstimator::costing_t _costing_type) {
...
std::tuple<int, int, float> Scheduler::greedy(std::shared_ptr<std::vector<std::shared_ptr<PickTask> > > _pick_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<DeliverTask> > > _deliver_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<RechargeTask> > > _recharge_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<Robot> > >& _robots_ref,
        CostEstimator::costing_t _costing_type) {
...
std::tuple<int, int, float> Scheduler::greedy_v2(std::shared_ptr<std::vector<std::shared_ptr<PickTask> > > _pick_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<DeliverTask> > > _deliver_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<RechargeTask> > > _recharge_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<Robot> > >& _robots_ref,
        CostEstimator::costing_t _costing_type) {
...
std::tuple<int, int, float> Scheduler::done(std::shared_ptr<std::vector<std::shared_ptr<PickTask> > > _pick_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<DeliverTask> > > _deliver_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<RechargeTask> > > _recharge_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<Robot> > >& _robots_ref,
        CostEstimator::costing_t _costing_type) {
...
std::tuple<int, int, float> Scheduler::done_cta(std::shared_ptr<std::vector<std::shared_ptr<PickTask> > > _pick_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<DeliverTask> > > _deliver_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<RechargeTask> > > _recharge_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<Robot> > >& _robots_ref,
        CostEstimator::costing_t _costing_type) {  
...
std::tuple<int, int, float> Scheduler::done_cpta(std::shared_ptr<std::vector<std::shared_ptr<PickTask> > > _pick_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<DeliverTask> > > _deliver_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<RechargeTask> > > _recharge_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<Robot> > >& _robots_ref,
        CostEstimator::costing_t _costing_type) {  
...
//domain zone based capacity and priority constrained task allocator (DoNe-CPTA)
std::tuple<int, int, float> Scheduler::done_cpta_v2(std::shared_ptr<std::vector<std::shared_ptr<PickTask> > > _pick_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<DeliverTask> > > _deliver_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<RechargeTask> > > _recharge_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<Robot> > >& _robots_ref,
        CostEstimator::costing_t _costing_type) {  
...
//domain zone based capacity and priority constrained task allocator (DoNe-CPTA)
std::tuple<int, int, float> Scheduler::done_cpta_v3(std::shared_ptr<std::vector<std::shared_ptr<PickTask> > > _pick_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<DeliverTask> > > _deliver_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<RechargeTask> > > _recharge_tasks_ref,
        std::shared_ptr<std::vector<std::shared_ptr<Robot> > >& _robots_ref,
        CostEstimator::costing_t _costing_type) {  
            ...
            if (n_dominants == 1)
                ...
                if (best_costed_tasks_ref->size() == 1) {
                    ...
                    if (greater_utility_tasks_ref->size() == 1)
                        ...
                        best_euler_tasks_ref = dom->euler_test(cur_robot, *greater_utility_tasks_ref);
#ifdef DEBUG
